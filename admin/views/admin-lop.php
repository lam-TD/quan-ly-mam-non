            ...
            <div class="card card-small mb-4">
                ...
                <div class="card-header border-bottom">
                    <form action="admin-loaitin.php" method="get">
                        ...
                        <button type="button" name="them" data-toggle="modal" data-target="#myModal" class="btn btn-info">Thêm mới lớp học</button>
                    </form>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button id="btn-save" onclick="insert_lop_hoc()" type="button" class="btn btn-success"><i class="glyphicon glyphicon-floppy-saved"></i> Lưu lại</button>
