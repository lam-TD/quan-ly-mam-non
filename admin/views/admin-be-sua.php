    ...
    <div class="row">
        <div class="col">
            <div class="card card-small mb-4" style="padding: 40px 60px">
                <h5 class="text-info">THÔNG TIN CỦA BÉ</h5>
                <div class="card-header">
                    ...
                    if (isset($_GET['id'])) {
                        $id_be = (int)$_GET['id'];
                        $query = "SELECT * FROM be WHERE id = {$id_be}";
                    ...
                    <form action="" method="post" enctype="multipart/form-data" style="margin-top: 30px">
                        ...
                        <br/>
                        <button name="btn-submit-be" type="submit" class="btn btn-info">Cập nhật Thông Tin</button>
                    </form>
                </div>
                <!-- End thêm loại tin -->
            </div>
